...
{
      15,     0,    -1,    16,    -1,     3,    -1,     4,    -1,     7,
      16,    -1,    16,     6,    16,    -1,    16,     7,    16,    -1,
      16,     8,    16,    -1,    16,     9,    16,    -1,    12,    16,
      13,    -1
};
...
{
  "$end", "error", "$undefined", "NUM", "DAT", "ERR", "'+'", "'-'", "'*'", 
  "'/'", "NEG", "'^'", "'('", "')'", "$accept", "input", "expr", 0
};
#endif
...
{
       7,     8,     1,     2,    12,    13,     3,    15,    16,    17,
      18,     4,    10,    11,    12,    13,     9,     0,     0,    14,
      10,    11,    12,    13
};

static const yysigned_char yycheck[] =
{
       3,     4,     3,     4,     8,     9,     7,    10,    11,    12,
      13,    12,     6,     7,     8,     9,     0,    -1,    -1,    13,
       6,     7,     8,     9
};
...
{
       0,     3,     4,     7,    12,    15,    16,    16,    16,     0,
       6,     7,     8,     9,    13,    16,    16,    16,    16
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 82 "stuff\\calc.ypp"
    { yyRoot = yyvsp[0]; ;}
    break;

  case 3:
#line 85 "stuff\\calc.ypp"
    { yyval = yyvsp[0]; ;}
    break;

  case 4:
#line 86 "stuff\\calc.ypp"
    { yyval = yyvsp[0]; ;}
    break;

  case 5:
#line 87 "stuff\\calc.ypp"
    { yyval = op(NEG_NODE, 1, yyvsp[0]); ;}
    break;

  case 6:
#line 88 "stuff\\calc.ypp"
    { yyval = op(ADD_NODE, 2, yyvsp[-2], yyvsp[0]); ;}
    break;

  case 7:
#line 89 "stuff\\calc.ypp"
    { yyval = op(SUB_NODE, 2, yyvsp[-2], yyvsp[0]); ;}
    break;

  case 8:
#line 90 "stuff\\calc.ypp"
    { yyval = op(MUL_NODE, 2, yyvsp[-2], yyvsp[0]); ;}
    break;

  case 9:
#line 91 "stuff\\calc.ypp"
    { yyval = op(DIV_NODE, 2, yyvsp[-2], yyvsp[0]); ;}
    break;

  case 10:
#line 92 "stuff\\calc.ypp"
    { yyval = yyvsp[-1]; ;}
    break;
